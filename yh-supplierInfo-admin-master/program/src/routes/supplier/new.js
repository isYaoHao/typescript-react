...
//         newArr.push(`order/images/returns/${file[i].uid}/${file[i].name.split('.'.slice(-1)[0])}`);
//     }
//     return newArr;
// }
...
export default class Suppliernew extends Component {
  ...
  render() {
    ...
    const { uploadToken, previewVisible, previewImage, fileList, imgFormArray } = this.state;
    ...
    return (
      <PageHeaderLayout title="供应商新增">
        <Card bordered={false} className={styles['formnew-wrap']} title="新增">
          <Form onSubmit={this.handleSubmit}>
            ...
            <FormItem {...formItemLayout} label="展示图片url">
